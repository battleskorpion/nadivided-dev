...
--NCountry = {
	NDefines.NCounttry.MIN_MAJOR_COUNTRIES	= 40,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
	NDefines.NCounttry.ADDITIONAL_MAJOR_COUNTRIES_IC_RATIO = 0.7,		-- Countries will also be considered major when having more factories that the average of top MIN_MAJOR_COUNTRIES countries' factories times ADDITIONAL_MAJOR_COUNTRIES_IC_RATIO
	NDefines.NCounttry.BASE_TENSION_MAJOR_COUNTRY_INDEX = 1,			-- Which major country should be considered the base country when scaling generated world tension. 0 is the country with the most factories, 1 is the second most-factories country etc. This number has to be lower than MIN_MAJOR_COUNTRIES

	NDefines.NCounttry.MIN_FOCUSES_FOR_CONTINUOUS = 8,				-- def 10 -- Focuses needed to unlock continuous focuses
	NDefines.NCounttry.POPULATION_YEARLY_GROWTH_BASE = 0.015,		-- def 0.015 -- basic population growth per year, used for monthly manpower gain
--},
