...
NDiplomacy = {
	...
	PEACE_INCREASE_COST_FACTOR_PER_MISSING_PERCENT_FOR_CAPITULATION = 0.001, 	-- increase factor if loser has not capitulated, for every percent between surrender level and BASE_SURRENDER_LEVEL
...
NCountry = {
	...
	MAJOR_MIN_FACTORIES = 33,						-- need at least these many factories to become a major
...
NMilitary = {
	...
	WAR_SCORE_LEND_LEASE_GIVEN_FUEL_FACTOR = 0.01,  			-- war score gained for every 100 units of fuel lend lease sent to allies
	WAR_SCORE_LEND_LEASE_RECEIVED_IC_FACTOR = 0.1,  			-- war score deducted for every IC of lend lease received from allies
	WAR_SCORE_LEND_LEASE_RECEIVED_FUEL_FACTOR = 0.01, 		-- war score deducted for every 100 units of fuel lend lease received from allies
