...
NCountry = {
	...
	MIN_MAJOR_COUNTRIES	= 100 ,						-- was 25, default 7? -- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
	...
	STATE_OCCUPATION_COST_MULTIPLIER = 0.02,		-- Multiplier for state value to PP cost for occupation
...
NProduction = {
	...
	BASE_FACTORY_SPEED = 4, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives). #base5
	BASE_FACTORY_SPEED_MIL = 2.85, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives). #base4.75
	BASE_FACTORY_SPEED_NAV = 4.5, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives). #base2.5
	BASE_FACTORY_START_EFFICIENCY_FACTOR = 10,	-- Base start efficiency for factories expressed in %.
	BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 32,	-- Base max efficiency for factories expressed in %.
	...
	ANNEX_STOCKPILES_RATIO = 0.30,		-- How much stockpiled equipment will be transferred on annexation
