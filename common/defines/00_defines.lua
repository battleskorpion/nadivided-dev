...
NGame = {
	...
	HANDS_OFF_START_TAG = "BER",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
...
NDiplomacy = {
	...
	WARGOAL_PER_JUSTIFY_AND_WAR_COST_FACTOR = 1.35,	-- Cost factor per nation at war with or justifying against
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.08,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
...
NCountry = {
	...
	WAR_SUPPORT_OFFNSIVE_WAR = -0.25,				-- Impact of being in offensive war
	...
	MAJOR_IC_RATIO = 1,                             -- difference in total factories needed to be considered major with respect to other nation
	MAJOR_MIN_FACTORIES = 3,						-- need at least these many factories to become a major
	...
	MIN_MANPOWER_RATIO = 0.02,						-- Min manpower ratio to show manpower alert
	...
	RESOURCE_IMPORTANCE_FACTOR = 0.7,				-- State resource importance factor for AI and calculations
	...
	MIN_MAJOR_COUNTRIES	= 100,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
	ADDITIONAL_MAJOR_COUNTRIES_IC_RATIO = 0.1,		-- Countries will also be considered major when having more factories that the average of top MIN_MAJOR_COUNTRIES countries' factories times ADDITIONAL_MAJOR_COUNTRIES_IC_RATIO
	...
	STATE_VALUE_MANPOWER_FACTOR = 0.2,              -- State cost increases with this for every 10k population (so 3.1M becomes 310 and then multiplied by this)
...
NResistance = {
	...
	RESISTANCE_COOLDOWN_WHEN_DISABLED = -0.2,				-- resistance cooldown when the state is taken back by its original owner (compliance is zeroed in that case)
	...
	FOREIGN_MANPOWER_MIN_THRESHOLD = 2500,		 -- The minimum number of Manpower that AI will accept to give at once, in order to avoid many weird little transfer.
	...
	FOREIGN_MANPOWER_AI_COOLDOWN_DAYS = 21,		 -- Number of days after an AI give us manpower before the AI accept to give more.
...
NProduction = {
	...
	BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 31,	-- Base max efficiency for factories expressed in %.
	...
	ANNEX_STOCKPILES_RATIO =0.35,		-- How much stockpiled equipment will be transferred on annexation
	...
	CAPITULATE_STOCKPILES_RATIO = 0.3, -- How much equipment from deployed divisions will be transferred on capitulation
...
NTechnology = {
	...
	BASE_TECH_COST = 105,					-- Base cost for a tech. multiplied with tech cost and ahead of time penalties
...
NSupply = {
	...
	NAVAL_BASE_STARTING_PENALTY_PER_PROVINCE = 0.81,
	...
	LOCAL_SUPPLY_PER_AIR_MISSION = 0.9, -- each assigned plane gives this much supply at full efficiency
