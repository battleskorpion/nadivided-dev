...
NProduction = {
	...
	BASE_FACTORY_SPEED_MIL = 3.25, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives). #base4.75
	...
	BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 47,	-- Base max efficiency for factories expressed in %.
