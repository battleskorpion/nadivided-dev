...
NDiplomacy = {
	...
	TENSION_PUPPET = 1.25,
	TENSION_FORCE_GOVERNMENT = 0.75,                -- Amount of tension generated by forcing government (per state)							-- Amount of tension generated by puppeting (per state)								-- default 1.5
